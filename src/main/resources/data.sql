...
(1, 'admin', '$2a$10$3Lt7be5w/QD0UA56O4tsX./r3K.bU1ELzg10NCyyrKSI20F2GrKby', true),
...
ALTER TABLE permission ALTER COLUMN id RESTART WITH 6;
ALTER TABLE role_permission ALTER COLUMN id RESTART WITH 6;
ALTER TABLE user_role ALTER COLUMN id RESTART WITH 3;
